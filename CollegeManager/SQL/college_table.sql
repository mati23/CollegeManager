...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[FK_CollegeId] (SqlForeignKeyConstraint) will not be renamed to FK_College_Id';
...
GO
PRINT N'Creating [dbo].[FK_College_Id]...';


GO
ALTER TABLE [dbo].[Subjects] WITH NOCHECK
    ADD CONSTRAINT [FK_College_Id] FOREIGN KEY ([CollegeId]) REFERENCES [dbo].[College] ([Id]);
...
GO
ALTER TABLE [dbo].[Subjects] WITH CHECK CHECK CONSTRAINT [FK_College_Id];
