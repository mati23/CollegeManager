...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[Table].[Registration_Number] (SqlSimpleColumn) will not be renamed to RegistrationNumber';
